...
CREATE TABLE users (
    ...
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
    CONSTRAINT email_must_be_company_email CHECK (((email)::text ~* '^[^@]+@beaukinstler\.info'::text))
);
...
INSERT INTO schema_migrations (version) VALUES ('20170910012322');

INSERT INTO schema_migrations (version) VALUES ('20170911001604');

INSERT INTO schema_migrations (version) VALUES ('20170912015920');

INSERT INTO schema_migrations (version) VALUES ('20170917235626');
